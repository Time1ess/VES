...
public class UIController : MonoBehaviour {
    ...
    public static UIController Instance
    {
        get
        {
            ...
            else
            {
				...
				uiController.transform.parent = GameObject.Find ("AugmentedRealityPlane").transform;
    ...
    private void InstantiateMenu(GameObject menuPrefab)
    {
		...
		menu.transform.parent = GameObject.Find ("CalibrationPlane").transform;
		menu.transform.localPosition = new Vector3 (-0.1f, 12f, -1f);
		menu.transform.localRotation = Quaternion.Euler (new Vector3 (90, 0, 0));
