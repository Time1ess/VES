...
typedef struct VideoState
{
    ...
    double          video_clock;  // pts of last decode frame / predicted pts of next decode frame
    AVStream        *video_st;
    PacketQueue     videoq;
...
int decode_frame_from_packet(VideoState *is, AVFrame decoded_frame)
{
    ...
    // Allocate source and destiantion samples buffers
    ...
    dst_nb_samples = av_rescale_rnd(
            swr_get_delay(is->sws_ctx_audio, src_rate) + src_nb_samples,
            dst_rate,
            src_rate,
            AV_ROUND_UP);
